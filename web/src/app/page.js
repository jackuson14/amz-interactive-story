      ...
      <section className="px-6 sm:px-10 md:px-16 py-12">
        <div className="mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-xl border bg-white p-6">
            <h3 className="font-semibold text-lg text-gray-900">Your face in the story</h3>
            <p className="mt-2 text-sm text-gray-600">
              We embed your face as the main character throughout the narrative.
            </p>
          </div>
          <div className="rounded-xl border bg-white p-6">
            <h3 className="font-semibold text-lg text-gray-900">Private by default</h3>
            <p className="mt-2 text-sm text-gray-600">
              Face data stays on your device in the MVP. Cloud stylization is optional and opt-in.
            </p>
          </div>
          <div className="rounded-xl border bg-white p-6">
            <h3 className="font-semibold text-lg text-gray-900">Fast and lightweight</h3>
            <p className="mt-2 text-sm text-gray-600">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <ol className="mt-6 space-y-4">
            <li className="rounded-lg border p-4">
              <span className="font-semibold text-gray-900">1. Capture</span>
              <p className="text-sm text-gray-600">Take a quick selfie during onboarding.</p>
            </li>
            <li className="rounded-lg border p-4">
              <span className="font-semibold text-gray-900">2. Stylize (optional)</span>
              <p className="text-sm text-gray-600">Use our stylized mode later; MVP uses a simple placeholder.
              </p>
            </li>
            <li className="rounded-lg border p-4">
              <span className="font-semibold text-gray-900">3. Play</span>
