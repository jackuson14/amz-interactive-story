      ...
      <section className="px-6 sm:px-10 md:px-16 py-8">
        <div className="mx-auto max-w-5xl">
          <div className="rounded-xl border bg-white p-4 sm:p-6">
            <div className="flex items-center gap-2 text-xs uppercase tracking-wide text-gray-500"><span className="inline-block w-6 h-6 rounded-full bg-indigo-600 text-white grid place-items-center">3</span> Your story idea</div>
          ...
          <div className="mt-8 rounded-xl border bg-white p-4 sm:p-6">
            ...
            <p className="mt-1 text-sm text-gray-600">
              Perfect stories for {characterAge ? `${characterAge} year olds` : 'your age'}
            </p>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {(PRESET_STORIES_BY_AGE[characterAge] || PRESET_STORIES_BY_AGE[4] || []).map((story) => (
                <div
                  key={story.id}
      ...
      {showModal && selectedStory && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <h4 className="font-bold text-lg mb-3 text-gray-900">Story Details</h4>
              <p className="text-gray-800 leading-relaxed mb-6 font-medium">
                {selectedStory.description || selectedStory.oneLiner}
              </p>
